...
GO
INSERT [dbo].[Approvals] ([id], [entityType], [entityId], [requestedByuser_id], [requestedByUserDisplayName], [requestedAt], [status], [details], [resolvedByuser_id], [resolvedByUserDisplayName], [resolvedAt], [resolverNotes]) VALUES (N'appr_1755109946324', N'parent_items', N'item_1753739146663', N'bIG0LVYH9paPEzBfayjU699tuxE2', NULL, CAST(N'2025-08-13T18:32:26.4866667' AS DateTime2), N'approved', N'{"from":"draft","to":"active"}', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-14T17:36:08.7233333' AS DateTime2), N'teste de aprovação')
INSERT [dbo].[Approvals] ([id], [entityType], [entityId], [requestedByuser_id], [requestedByUserDisplayName], [requestedAt], [status], [details], [resolvedByuser_id], [resolvedByUserDisplayName], [resolvedAt], [resolverNotes]) VALUES (N'appr_1755199863647', N'parent_items', N'item_1753739146663', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-14T19:31:03.8266667' AS DateTime2), N'approved', N'{"from":"draft","to":"active"}', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-14T19:31:36.0166667' AS DateTime2), NULL)
INSERT [dbo].[Approvals] ([id], [entityType], [entityId], [requestedByuser_id], [requestedByUserDisplayName], [requestedAt], [status], [details], [resolvedByuser_id], [resolvedByUserDisplayName], [resolvedAt], [resolverNotes]) VALUES (N'appr_1755200012834', N'parent_items', N'item_1753739146663', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-14T19:33:33.1333333' AS DateTime2), N'approved', N'{"from":"active","to":"maintenance"}', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-14T21:11:55.3800000' AS DateTime2), NULL)
INSERT [dbo].[Approvals] ([id], [entityType], [entityId], [requestedByuser_id], [requestedByUserDisplayName], [requestedAt], [status], [details], [resolvedByuser_id], [resolvedByUserDisplayName], [resolvedAt], [resolverNotes]) VALUES (N'appr_1755205933669', N'parent_items', N'item_1753739146663', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-14T21:12:13.7500000' AS DateTime2), N'rejected', N'{"from":"maintenance","to":"active"}', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-14T21:13:20.6700000' AS DateTime2), NULL)
INSERT [dbo].[Approvals] ([id], [entityType], [entityId], [requestedByuser_id], [requestedByUserDisplayName], [requestedAt], [status], [details], [resolvedByuser_id], [resolvedByUserDisplayName], [resolvedAt], [resolverNotes]) VALUES (N'appr_1755279419134', N'child_items', N'citem_1755279025220', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-15T17:36:59.2100000' AS DateTime2), N'rejected', N'{"from":"draft","to":"active"}', N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', CAST(N'2025-08-15T17:37:32.5600000' AS DateTime2), N'nda a dizer')
GO
SET IDENTITY_INSERT [dbo].[AuditLog] ON 

INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (670, CAST(N'2025-08-15T16:37:16.9700000' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'item_1753739146663', N'{"x":{"old":4,"new":5},"y":{"old":2,"new":2}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (671, CAST(N'2025-08-15T16:37:23.1466667' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"x":{"old":3,"new":4},"y":{"old":2,"new":4}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (672, CAST(N'2025-08-15T17:30:29.6766667' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_CREATED', N'child_items', N'citem_1755279025220', N'{"id":"citem_1755279025220","label":"SWPABLM-01","type":"Switch","modelo":"Catalyst 9300 48-port","brand":"Cisco","parent_id":"pitem_1755025212787","status":"draft","posicaoU":10,"tamanhoU":1}')
...
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (674, CAST(N'2025-08-15T18:33:23.0400000' AS DateTime2), N'system_admin', N'System Admin', N'USER_DELETED', N'User', N'user_1722384661021', N'{"email":"manager@example.com","displayName":"Maria Gerente (Teste)"}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (675, CAST(N'2025-08-15T18:34:35.5500000' AS DateTime2), N'system_admin', N'System Admin', N'USER_CREATED', N'User', N'p66utzeIl5QlvzQUpeyyKLwzrER2', N'{"data":{"email":"testeusuarionovo@exeplo.com","role":"technician_1"}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (676, CAST(N'2025-08-15T20:30:27.7000000' AS DateTime2), N'system_admin', N'System Admin', N'USER_UPDATED', N'User', N'p66utzeIl5QlvzQUpeyyKLwzrER2', N'{"data":{"email":"testeusuarionovo@exeplo.com","role":"technician_1"}}')
...
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (680, CAST(N'2025-08-18T23:35:17.9333333' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"y":{"old":4,"new":5},"x":{"old":4,"new":4}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (681, CAST(N'2025-08-18T23:35:32.4400000' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"x":{"old":4,"new":3},"y":{"old":5,"new":4}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (682, CAST(N'2025-08-18T23:38:23.6633333' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"y":{"old":4,"new":2},"x":{"old":3,"new":3}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (683, CAST(N'2025-08-18T23:39:13.7000000' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"x":{"old":3,"new":4},"y":{"old":2,"new":2}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (684, CAST(N'2025-08-18T23:40:23.0966667' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"y":{"old":2,"new":3},"x":{"old":4,"new":4}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (685, CAST(N'2025-08-18T23:40:29.7000000' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"y":{"old":3,"new":2},"x":{"old":4,"new":4}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (686, CAST(N'2025-08-18T23:40:54.2633333' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"y":{"old":2,"new":3},"x":{"old":4,"new":4}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (687, CAST(N'2025-08-18T23:40:57.3933333' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'pitem_1755025212787', N'{"y":{"old":3,"new":2},"x":{"old":4,"new":4}}')
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (688, CAST(N'2025-08-19T21:44:46.2900000' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'EVIDENCE_ADDED', N'Incidents', N'inc_1755557539397', N'{"evidenceType":"note","text":"teste"}')
...
INSERT [dbo].[AuditLog] ([id], [timestamp], [user_id], [userDisplayName], [action], [entityType], [entityId], [details]) VALUES (690, CAST(N'2025-08-20T19:06:12.4700000' AS DateTime2), N'bIG0LVYH9paPEzBfayjU699tuxE2', N'Davidson Santos Conceição', N'ITEM_UPDATED', N'parent_items', N'item_1722383173367', N'{"room_id":{"old":null,"new":"R1753383480097"},"x":{"old":2,"new":6},"y":{"old":1,"new":8}}')
...
GO
INSERT [dbo].[child_items] ([id], [label], [parent_id], [type], [status], [serialNumber], [brand], [tag], [isTagEligible], [ownerEmail], [dataSheetUrl], [description], [imageUrl], [modelo], [preco], [trellisId], [tamanhoU], [posicaoU], [isTestData]) VALUES (N'citem_001', N'SW-CORE-TESTE-01', N'pitem_001', N'Switch', N'active', NULL, N'Cisco', NULL, NULL, NULL, NULL, NULL, NULL, N'Catalyst 9300 48-port', NULL, NULL, 1, 40, 1)
...
GO
INSERT [dbo].[Evidence] ([id], [timestamp], [type], [data], [entityId], [entityType], [user_id]) VALUES (N'evid_1755639886107', CAST(N'2025-08-19T21:44:46.1733333' AS DateTime2), N'note', N'{"text":"teste"}', N'inc_1755557539397', N'Incidents', N'bIG0LVYH9paPEzBfayjU699tuxE2')
INSERT [dbo].[Evidence] ([id], [timestamp], [type], [data], [entityId], [entityType], [user_id]) VALUES (N'evid_1755640030128', CAST(N'2025-08-19T21:47:10.2033333' AS DateTime2), N'image', N'{"url":"https://infravisionstorage.blob.core.windows.net/infravision-images/evidence-incident-inc_1755557539397-1755640033111.jpg"}', N'inc_1755557539397', N'Incidents', N'bIG0LVYH9paPEzBfayjU699tuxE2')
GO
...
GO
INSERT [dbo].[Rooms] ([id], [name], [building_id], [depthM], [widthM], [tileWidthCm], [tileHeightCm], [xAxisNaming], [yAxisNaming], [isTestData], [backgroundImageUrl], [backgroundScale], [backgroundPosX], [backgroundPosY], [widthM_new], [depthM_new]) VALUES (N'R1722382686121', N'Sala de Testes 1A', N'B1722382574515', 15, 20, 60, 60, N'alpha', N'numeric', 1, NULL, NULL, NULL, NULL, NULL, NULL)
...
INSERT [dbo].[Rooms] ([id], [name], [building_id], [depthM], [widthM], [tileWidthCm], [tileHeightCm], [xAxisNaming], [yAxisNaming], [isTestData], [backgroundImageUrl], [backgroundScale], [backgroundPosX], [backgroundPosY], [widthM_new], [depthM_new]) VALUES (N'R1753383463926', N'Switch', N'B1753382923932', 5, 5, 60, 60, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL)
